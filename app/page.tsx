...
export default function Landing() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen h-full py-10 bg-stone-900 ">
      <nav className="fixed top-3 w-96 bg-stone-900">
        <h1 className="text-white text-2xl font-bold">Onstep</h1>
      </nav>

      <main className="flex flex-col-reverse md:flex-col items-center justify-center h-full bg-stone-900">
